    ...
    <form action="{{ route('admin.home-content.update') }}" method="POST" enctype="multipart/form-data"
        ...
        <ul class="nav nav-pills cms-nav gap-2 mb-4 d-none" role="tablist">
            <li class="nav-item" role="presentation"><button class="nav-link active" data-bs-toggle="pill"
                    data-bs-target="#tabSambutan" type="button">1. Sambutan</button></li>
            <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="pill"
                    data-bs-target="#tabTeachers" type="button">2. Guru</button></li>
            <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="pill"
                    data-bs-target="#tabGallery" type="button">3. Galeri</button></li>
            <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="pill"
                    data-bs-target="#tabNews" type="button">4. Berita</button></li>
            <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="pill"
                    data-bs-target="#tabAchievements" type="button">5. Prestasi</button></li>
            <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="pill"
                    data-bs-target="#tabPpdb" type="button">6. PPDB</button></li>
            <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="pill"
                    data-bs-target="#tabContact" type="button">7. Kontak</button></li>
        </ul>

        <div class="tab-content">
            <div class="tab-pane fade show active" id="tabSambutan">
                <p class="text-secondary small mb-3">Teks ini tampil di section Sambutan Kepala Sekolah pada halaman depan.
                </p>
                <div class="cms-item">
                    <label class="form-label fw-semibold">Isi Sambutan Kepala Sekolah</label>
                    <textarea class="form-control" rows="10" name="headmaster_greeting" placeholder="Tulis sambutan di sini...">{{ old('headmaster_greeting', $headmasterGreeting) }}</textarea>
                    <small class="text-secondary d-block mt-2">Tips: pisahkan paragraf dengan baris kosong agar tampil
                        rapi.</small>
                </div>
            </div>
                        ...
                        <div class="col-12 teacher-item cms-item">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-4"><input class="form-control"
                                        ...
                                        value="{{ $teacher['email'] ?? '' }}" placeholder="Email"></div>
                                <div class="col-md-4"><input class="form-control"
                                        name="teachers[{{ $index }}][phone]"
                                        value="{{ $teacher['phone'] ?? '' }}" placeholder="Telepon"></div>
                                <div class="col-12">
